...
if __name__ == '__main__':
    ...
    # Get the input file from argparse argument.
    argparse_parser = argparse.ArgumentParser(description='Split OCCAM Gaussian Splat PLY file into embeddings and stripped PLY.')
    argparse_parser.add_argument('input_file', type=str, help='Path to the input PLY file.')
